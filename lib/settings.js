...
exports.coin = {
  ...
  "name": "Exor",
  // symbol: The cryptocurrency coin ticker/symbol value. This value is displayed anywhere that coin data is displayed including the index, address, block, movement, reward, richlist/top1000 and tx pages
  "symbol": "EXOR"
};
...
// richlist_page: a collection of settings that pertain to the richlist/top1000 page
exports.richlist_page = {
  // enabled: Enable/disable the richlist/top1000 page (true/false)
  //          If set to false, the richlist/top1000 page will be completely inaccessible
  "enabled": true,
  // show_panels: Determine whether to show the panels configured in the shared_pages.page_header section across the top of this page (true/false)
  "show_panels": false,
  // show_nethash_chart: Determine whether to show the network hashrate chart configured in the shared_pages.network_charts.nethash_chart section across the top of this page (true/false)
  ...
  // show_difficulty_chart: Determine whether to show the network difficulty chart configured in the shared_pages.network_charts.difficulty_chart section across the top of this page (true/false)
  "show_difficulty_chart": false,
  // page_header: a collection of settings that pertain to the richlist/top1000 page header
  "page_header": {
    // show_img: Determine whether to show the page title image defined in the "shared_pages.page_header.page_title_image" setting (true/false)
    "show_img": true,
  ...
  // wealth_distribution: a collection of settings that pertain to the wealth distribution section of the richlist/top1000 page
  //                      This section features a summary table with the breakdown of coins owned by the top 1-25, 26-50, 51-75, 76-100, 100-1000, 101+ wallets and all burned coins plus an associated pie chart
  "wealth_distribution": {
  ...
  // burned_coins: a collection of settings that pertain to the wallet addresses that should not appear in the richlist/top1000 page
  //               NOTE: These settings won't take effect until after running (and completing) a normal index sync or reindex-rich
  "burned_coins": {
    // addresses: An array of wallet addresses to exclude from the richlist/top1000 page
